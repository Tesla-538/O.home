...
export const RESET_CONTENT: ResetGroup[] = [
  ...
  { key: 'trpg', label: '설정노트', keys: ['ohome.trpg.v1', 'ohome.trpgbody.v1'] },
  { key: 'tchars', label: '자캐도감', keys: ['ohome.tchars.v1'] },
  { key: 'dotori', label: '세계관', keys: ['ohome.dotori.v1'] },
  { key: 'playlog', label: '에피소드', keys: ['ohome.playlog.v1'] },
  { key: 'rp', label: '장면보관함', keys: ['ohome.rp.v1'] },
